local locales = {
  ["ptBR"] = {
    ...
    ["Banker"] = "Caixa do Banco",
    ["Battlemaster"] = "Mestre de Batalha",
    ["Buy"] = "Comprar",
    ["Chests & Treasures"] = "Baús & Tesouros",
    ...
    ["Display related objects like ores, herbs, chests, etc."] = "Mostrar objetos relacionados como minérios, plantas, baús, etc.",
    ...
    ["Explore"] = "Explorar",
    ["Fishing Pools"] = "Locais de Pesca",
    ["Flight Master"] = "Mestre de Voo",
    ["Friendly"] = "Amigável",
    ["General"] = "Geral",
    ["Herbalism"] = "Herborismo",
    ["Herbs & Flowers"] = "Plantas & Flores",
    ...
    ["Meeting Stones"] = "Pedras de Encontro",
    ["Mines & Ores"] = "Minas & Minérios",
    ...
    ["Show herbs with an appropriate skill level for your character"] = "Mostrar plantas com um nível de habilidade adequado ao seu personagem",
    ["Show herbs with skill range of [min] to [max]"] = "Mostrar plantas com nível de habilidade de [min] a [max]",
